...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestedFunction() can access 'internal' because 'internal' is declared in myFunction(), which defines the parent block of nestedFunction(). 
...
const zooAnimals = [
 ...
 function animalNames(animals) {
  return animals.map(
    (e) => `name: ${e.animal_name}, scientific: ${e.scientific_name}`
  );
}
 ...
 function lowerCaseNames(animals) {
  return animals.map((e) => e.animal_name.toLowerCase());
}
 ...
 function lowPopulationAnimals(animals) {
  return animals.filter((e) => e.population < 5);
}
 ...
 function USApop(animals) {
  return animals.reduce((a, b) => a + b.population, 0);
}
